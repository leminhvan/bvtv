...
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/vendors/datatable/jquery.dataTables.min.css">
...
<script type="text/javascript" src="<?php echo base_url()?>assets/vendors/datatable/jquery.dataTables.min.js"></script>
