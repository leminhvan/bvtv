...
<?php if ($this->ion_auth->is_admin()): ?>
    <div class="form-group">
        ...
        <?php   $phanquyen = explode(',', $user->phanquyen); //var_dump($phanquyen);
...
<?php endif ?>
                            ...
                            <?php 
                                if($user->avatar != '') {
                                    $avatar = 'style="height: 200px; width: 200px" src="'.base_url().'uploads/'.$user->username.'/avatar/'.$user->avatar.'"';
                                } else{
                                    $avatar ='';        
                                } 
                            ?>
