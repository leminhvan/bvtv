    ...
    <?php echo form_open(site_url($action), 'id="form_chuangoc" class="form-horizontal" role="form"'); ?>
        ...
        <div class="card-body card-padding">
            ...
            <div class="form-group">
                <label  for="hcgoc_name" class="col-sm-2 control-label"><?php echo lang('hcgoc_name').' '; ?></label>
                <div class="col-sm-10">
                    <div class="fg-line">
                         <?php                  
                       echo form_input(
            ...
            <div class="form-group">
                <label  for="hcgoc_lot" class="col-sm-2 control-label"><?php echo lang('hcgoc_lot').' '; ?></label>
                <div class="col-sm-10">
                    <div class="fg-line">
                        <?php                  
                          echo form_input(
            ...
            <div class="form-group">
                <label  for="hcgoc_luongnhap" class="col-sm-2 control-label"><?php echo lang('hcgoc_luongnhap').' '; ?></label>
                <div class="col-sm-8">
                    <div class="fg-line">
                        <?php      
            ...
            <div class="form-group">
                <label  for="hcgoc_expday" class="col-sm-2 control-label"><?php echo lang('hcgoc_expday').' '; ?></label>
                <div class="col-sm-10">
                    <div class="fg-line">
                        <?php                  
                          echo form_input(
