...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 22, 2018 lúc 07:33 AM
...
--
-- Cấu trúc bảng cho bảng `bvtv_dangnenmau`
--
...
--
-- Đang đổ dữ liệu cho bảng `bvtv_dangnenmau`
--
...
INSERT INTO `bvtv_ketqua` (`ketqua_id`, `mau_id`, `chuan_id`, `hc_pha_id`, `s_chuan1`, `s_chuan2`, `m_mau`, `v_mau`, `s_mau`, `hl_dk`, `dk_donvi`, `ngay_tao`, `kq_phantram`) VALUES
(4, 2, 11, '2,4', 12, 12, 12, 12, 12, 99, '%(w/w)', '18-06-2018', 100);
...
--
-- Đang đổ dữ liệu cho bảng `bvtv_mau`
--
...
(2, 'Acetamiprid', 'VICB41801111', '09-06-2018', '22-06-2018', 2, '4', '%(w/w)', 2, '', ''),
(3, 'Zineb', 'VICB41801111', '09-06-2018', '22-06-2018', 2, '', '%(w/w)', 1, NULL, ''),
(4, 'Deltamethrin', 'VICB41800006', '18-06-2018', '20-06-2018', 3, NULL, '%(w/v)', 2, '54', '');
...
INSERT INTO `bvtv_phuongphap` (`pp_id`, `chitieu`, `maso_sop`, `phien_ban`, `hieu_luc`, `ten_sop`, `nen_mau`, `hoachat`, `17025`, `chidinh`, `pp_thu`, `note`) VALUES
(1, 'Azoxystrobin', '38', '02', '01-10-2017', 'Thuốc bảo vệ thực vật chứa hoạt chất Azoxystrobin - Xác định hàm lượng hoạt chất', '1,2', '1,2,g_12', 1, 0, 'GC-FID', '');
...
(1, 137, '2018-06-01 01:52:09'),
(2, 92, '2018-06-04 01:50:31'),
(3, 93, '2018-06-04 02:42:24'),
(4, 94, '2018-06-04 03:20:04'),
(5, 95, '2018-06-04 06:31:56'),
(6, 96, '2018-06-05 01:22:09'),
(7, 97, '2018-06-05 01:38:55'),
(8, 98, '2018-06-06 05:59:45'),
(9, 99, '2018-06-06 07:10:57'),
(10, 100, '2018-06-06 07:38:32'),
(11, 101, '2018-06-13 01:09:12'),
...
(29, 119, '2018-06-18 02:10:00'),
(30, 120, '2018-06-18 04:12:31'),
(31, 121, '2018-06-19 04:11:59'),
(32, 122, '2018-06-19 09:42:52'),
(33, 123, '2018-06-20 01:44:26'),
(34, 124, '2018-06-20 01:45:14'),
(35, 125, '2018-06-20 03:54:23'),
(36, 126, '2018-06-20 06:38:59'),
(37, 127, '2018-06-20 06:40:42'),
(38, 128, '2018-06-20 07:28:20'),
(39, 129, '2018-06-20 08:53:37'),
(40, 130, '2018-06-21 03:29:39'),
(41, 131, '2018-06-21 04:06:31'),
(42, 132, '2018-06-21 04:08:22'),
(43, 133, '2018-06-21 04:24:08'),
(44, 134, '2018-06-21 05:13:18'),
(45, 135, '2018-06-21 09:19:44'),
(46, 136, '2018-06-22 04:15:44'),
(47, 137, '2018-06-22 06:24:21');
...
(232, '::1', 'ov1j124pltoli7nhn4oo3v71shj2e6m9', '2018-06-22 13:43:00'),
(233, '::1', 'qtnubsgq2hil08djtss8ud5hj7g9skmb', '2018-06-22 13:45:42'),
(234, '::1', 'uo2fhqmchsvploaa6q45irqornsom26u', '2018-06-22 13:55:17');
...
(1, '127.0.0.1', 'Admin', '$2y$08$W4MjVDfFCqUN2nR9oYPSdet9egCrwT86le0oAOFLeiw/L76R7Tihy', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1529648661, 1, 'Lê Minh Vấn', '', '15-02-1992', '01667654356', '4.jpg', 'Nam', '1_0,4_0,5_0,5_1,5_2,5_3,5_4,9_0,9_1,9_2,9_3,9_4,7_0,11_0,11_1,11_2,11_3,11_4,19_0,19_1,19_2,19_3,19_4,10_0,16_0,16_1,16_2,16_3,16_4,17_0,17_1,17_2,17_3,17_4,13_0,13_1,13_2,13_3,13_4,18_0,18_1,18_2,18_3,18_4'),
...
--
-- Chỉ mục cho bảng `bvtv_dangnenmau`
--
...
--
-- AUTO_INCREMENT cho bảng `bvtv_dangnenmau`
--
ALTER TABLE `bvtv_dangnenmau`
...
--
ALTER TABLE `bvtv_mau`
  MODIFY `mau_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `sys_counter`
  MODIFY `counter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
